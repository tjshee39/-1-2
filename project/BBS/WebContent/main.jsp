...
<body>
    ...
    <div id="buttons2">
    <div id="dream">
        <h2 id="dreamh2" style="font-family: 'Nanum Myeongjo', serif; text-align: center;">꿈</h2>
        <h4 id ="dreamh4" style="font-family: 'Nanum Myeongjo', serif; text_align: center; color: #dcd7ee;">
