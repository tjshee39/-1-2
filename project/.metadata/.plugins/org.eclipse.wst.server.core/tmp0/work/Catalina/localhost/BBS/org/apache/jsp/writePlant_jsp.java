 ...
 * Generated at: 2020-06-29 13:11:17 UTC
...
public final class writePlant_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  //로그인 되어있지 않은 경우만 나올 수 있음(접속하기)
      ...
      out.write("\t\t<form method=\"post\" action=\"writePlantAction.jsp\">  <!-- 사용자가 작성한 글 제목과 내용이 writeAction.jsp로 보내짐 -->\r\n");
      ...
      out.write("\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td><input type = \"text\" class=\"form-control\" placeholder=\"글 제목\" name=bbsPlantTitle maxlength=\"50\"></td>\r\n");
      out.write("\t\t\t\t</tr>\t    <!-- input: action페이지에 전송 -->\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td><textarea class=\"form-control\" placeholder=\"글 내용\" name=bbsPlantContent maxlength=\"2048\" style=\"height: 350px;\"></textarea></td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</tbody>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t<input type = \"submit\" class=\"btn btn-primary pull-right\" value=\"글쓰기\">  <!-- 오른쪽에 글쓰기버튼 -->\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
