 ...
 * Generated at: 2020-06-30 05:35:43 UTC
...
public final class viewPlant_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  //로그인 되어있지 않은 경우만 나올 수 있음(접속하기)
      ...
      out.print( bbsplant.getBbsPlantTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
      ...
      out.write("\t\t\t\t\t<td style=\"width: 20%;\">");
      out.print( bbsplant.getBbsPlantDate().substring(0, 11) + bbsplant.getBbsPlantDate().substring(11, 13) 
      ...
      out.write("\t\t\t\t\t\t");
      out.print( bbsplant.getBbsPlantContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
						.replaceAll(">", "&gt;").replaceAll("\n", "<br/>") );
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t</tbody>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t<a href = \"bbsPlant.jsp\" class = \"btn btn-primary\">목록</a>\r\n");
      out.write("\t\t\t");

				if (userID != null && userID.equals(bbsplant.getUserID())) {  //본인이 쓴 글이라면 수정, 삭제 가능
			
      out.write("\r\n");
      out.write("\t\t\t\t\t<a href=\"updatePlant.jsp?bbsPlantID=");
      out.print( bbsPlantID );
      out.write("\" class = \"btn btn-primary\">수정</a>\r\n");
      out.write("\t\t\t\t\t<a onclick=\"return confirm('삭제하시겠습니까?')\" href=\"deletePlantAction.jsp?bbsPlantID=");
      out.print( bbsPlantID );
      out.write("\" \r\n");
