 ...
 * Generated at: 2020-06-30 06:34:49 UTC
...
public final class viewLife_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  //로그인 되어있지 않은 경우만 나올 수 있음(접속하기)
      ...
      out.print( bbslife.getBbsLifeTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
      ...
      out.write("\t\t\t\t\t<td style=\"width: 20%;\">");
      out.print( bbslife.getBbsLifeDate().substring(0, 11) + bbslife.getBbsLifeDate().substring(11, 13) 
      ...
      out.write("\t\t\t\t\t\t");
      out.print( bbslife.getBbsLifeContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;")
						.replaceAll(">", "&gt;").replaceAll("\n", "<br/>") );
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t</tbody>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t<a href = \"bbsLife.jsp\" class = \"btn btn-primary\">목록</a>\r\n");
      out.write("\t\t\t");
