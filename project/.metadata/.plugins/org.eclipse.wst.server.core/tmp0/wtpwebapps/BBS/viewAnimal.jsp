		...
		<div class="row">  <!-- table-striped: 게시판의 글 목록들이 홀/짝수 번갈아가면서 색상 변경 -->
			...
			<tbody>
				<tr>
					...
					<td style="width: 20%;"><%= bbsanimal.getBbsAnimalTitle().replaceAll(" ", "&nbsp;")
				...
				<tr>
					<td>작성일자</td>
					<td style="width: 20%;"><%= bbsanimal.getBbsAnimalDate().substring(0, 11) 
			...
			<a href = "bbsAnimal.jsp" class = "btn btn-primary">목록</a>
			<%
				if (userID != null && userID.equals(bbsanimal.getUserID())) {  //본인이 쓴 글이라면 수정, 삭제 가능
			%>
					<a href="updateAnimal.jsp?bbsAnimalID=<%= bbsAnimalID %>" class = "btn btn-primary">수정</a>
