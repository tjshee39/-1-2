...
<!-- 글작성 -->
	...
	<div class="container">  <!-- 특정한 내용을 담을 수 있는 container 지정 -->
		...
		<form method="post" action="writeInsectAction.jsp">  <!-- 사용자가 작성한 글 제목과 내용이 writeAction.jsp로 보내짐 -->
			...
			<tbody>
				<tr>
					<td><input type = "text" class="form-control" placeholder="글 제목" name=bbsInsectTitle
					 maxlength="50"></td>
