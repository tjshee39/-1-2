 ...
 * Generated at: 2020-12-14 01:45:34 UTC
...
import bbsplant.BbsPlantDAO;
import bbsplant.BbsPlant;
import java.util.ArrayList;

public final class bbsPlant_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("bbsplant.BbsPlantDAO");
    _jspx_imports_classes.add("bbsplant.BbsPlant");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
   ...
   //로그인 된 사람들의 정보를 담을 수 있도록 만듦
      ...
      out.write("\t\t\t\t<li class=\"active\"><a href=\"bbsPlant.jsp\">식물</a>\r\n");
  ...
  //로그인 되어있지 않은 경우만 나올 수 있음
      ...
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print( list.get(i).getBbsPlantID() );
      out.write("</td> \r\n");
      out.write("\t\t\t\t\t<td><a href=\"viewPlant.jsp?bbsPlantID=");
      out.print(list.get(i).getBbsPlantID() );
      out.write('"');
      out.write('>');
      out.print( list.get(i).getBbsPlantTitle() );
      out.write("</a></td>\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print( list.get(i).getBbsPlantDate().substring(0, 11) + list.get(i).getBbsPlantDate().substring(11, 13) 
					+ "시" + list.get(i).getBbsPlantDate().substring(14, 16) + "분" );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<!-- substirng: 필요한 부분만 잘라서 출력 -->\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print( list.get(i).getBbsPlantHit() );
      out.write("</td>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t<a href=\"bbsPlant.jsp?pageNumber=");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /bbsPlant.jsp(142,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\t\t\t\t\t<a href=\"writePlant.jsp\" class=\"btn btn-primary pull-right\" style=\"background-color: #b7b7b7; border-color: #b7b7b7;\">글쓰기</a>\r\n");
          out.write("\t\t\t\t");
