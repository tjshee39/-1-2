 ...
 * Generated at: 2020-12-12 13:46:32 UTC
...
public final class viewPlant_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  //로그인 되어있지 않은 경우만 나올 수 있음(접속하기)
      ...
      out.print( bbsplant.getBbsPlantTitle().replaceAll(" ", "&nbsp;")
      ...
      out.print( bbsplant.getUserID() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>조회수</td>\r\n");
      out.write("\t\t\t\t\t<td style=\"width: 20%;\">");
      out.print( bbsplant.getBbsPlantHit() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"2\">작성일자</td>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"2\" style=\"width: 20%;\">");
      out.print( bbsplant.getBbsPlantDate().substring(0, 11) 
					+ bbsplant.getBbsPlantDate().substring(11, 13) 
					+ "시" + bbsplant.getBbsPlantDate().substring(14, 16) + "분");
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t");
      out.print( bbsplant.getBbsPlantContent().replaceAll(" ", "&nbsp;")
						.replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br/>") );
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t</tbody>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t<a href = \"bbsPlant.jsp\" class = \"btn btn-primary\" style=\"background-color: #b7b7b7; border-color: #b7b7b7;\">목록</a>\r\n");
      out.write("\t\t\t");
      //  c:if
      ...
      try {
        ...
        // /viewPlant.jsp(145,3) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
