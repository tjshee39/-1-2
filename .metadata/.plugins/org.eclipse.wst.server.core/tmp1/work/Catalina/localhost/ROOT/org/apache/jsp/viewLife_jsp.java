 ...
 * Generated at: 2020-12-12 13:48:02 UTC
...
public final class viewLife_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  //로그인 되어있지 않은 경우만 나올 수 있음(접속하기)
      ...
      out.print( bbslife.getBbsLifeTitle().replaceAll(" ", "&nbsp;")
      ...
      out.print( bbslife.getUserID() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>조회수</td>\r\n");
      out.write("\t\t\t\t\t<td style=\"width: 20%;\">");
      out.print( bbslife.getBbsLifeHit() );
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"2\">작성일자</td>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"2\" style=\"width: 20%;\">");
      out.print( bbslife.getBbsLifeDate().substring(0, 11) 
					+ bbslife.getBbsLifeDate().substring(11, 13) 
					+ "시" + bbslife.getBbsLifeDate().substring(14, 16) + "분");
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t");
      out.print( bbslife.getBbsLifeContent().replaceAll(" ", "&nbsp;")
						.replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br/>") );
      out.write("\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t</tbody>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t<a href = \"bbsLife.jsp\" class = \"btn btn-primary\" style=\"background-color: #b7b7b7; border-color: #b7b7b7;\">목록</a>\r\n");
      out.write("\t\t\t");
      //  c:if
      ...
      try {
        ...
        // /viewLife.jsp(144,3) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        ...
        if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n");
            out.write("\t\t\t\t<a href=\"updateLife.jsp?bbsLifeID=");
            out.print( bbsLifeID );
            out.write("\" class = \"btn btn-primary\" style=\"background-color: #b7b7b7; border-color: #b7b7b7;\">수정</a>\r\n");
            out.write("\t\t\t\t<a onclick=\"return confirm('삭제하시겠습니까?')\" href=\"deleteLifeAction.jsp?bbsLifeID=");
            out.print( bbsLifeID );
