...
<!-- 글 수정 -->
	...
	<div class="container">  <!-- 특정한 내용을 담을 수 있는 container 지정 -->
		<div class="row">  <!-- table-striped: 게시판의 글 목록들이 홀/짝수 번갈아가면서 색상 변경 -->
			<form method="post" action="updateInsectAction.jsp?bbsInsectID=<%= bbsInsectID %>">  <!-- bbsID가 updateAction.jsp로 보내짐 -->
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							...
							name="bbsInsectTitle" maxlength="50" 
							value=<%= bbsinsect.getBbsInsectTitle() %>></td>  <!-- 수정하기 전의 제목 보여줌 -->
						</tr>	   
						<tr>
							<td><textarea class="form-control" placeholder="글 내용" name="bbsInsectContent" 
							maxlength="2048" 
							style="height: 350px;"><%= bbsinsect.getBbsInsectContent() %></textarea></td>
							<!-- 수정하기 전의 내용 보여줌 -->
						</tr>
					</tbody>
				</table>
